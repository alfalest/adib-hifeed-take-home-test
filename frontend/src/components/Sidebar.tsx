  ...
  const navItems = [
    {
      ...
      icon: (
        <svg className="sidebar-nav-icon" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      <div className="sidebar-footer">
        <div className="sidebar-user">
          ...
          <div className="sidebar-user-info">
            <div className="sidebar-user-name">Supervisor</div>
            <div className="sidebar-user-role">Gudang Pusat</div>
          </div>
        </div>
      </div>
    </aside>
